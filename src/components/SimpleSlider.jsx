...
const SimpleSlider = () => {
  ...
  return (
    <div>
      <Slider {...settings}>
        <div className="!flex justify-between items-center bg-gray-100 px-8 rounded">
        ...
        <div className="!flex justify-between items-center bg-gray-100 px-8">
          ...
          <img
            src="https://static.nike.com/a/images/t_default/fdded470-0ac5-4bd7-b41b-1bb63e161438/custom-nike-air-force-1-mid-by-you-shoes.png"
            alt="sneaker_image"
          ></img>
        </div>
      </Slider>
